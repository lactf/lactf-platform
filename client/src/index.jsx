  ...
  withStyles(
    {
      ...
      root: {
        ...
        "& *:not(code):not(pre)": {
          fontFamily:
            '"Poppins", -apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Noto Sans", "Oxygen", "Ubuntu", "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol" !important',
        },
        "& pre.code": {
          padding: "10px",
      ...
      "@global select": {
        background:
          "url(\"data:image/svg+xml;charset=utf8,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%204%205'%3E%3Cpath%20fill='%23667189'%20d='M2%200L0%202h4zm0%205L0%203h4z'/%3E%3C/svg%3E\") right .85rem center/.5rem .6rem no-repeat no-repeat var(--bg-darker) !important",
      },
      "@global :root": {
      ...
      '@global input:not([type="checkbox"]):not([type="radio"]):not([type="submit"]):focus, select:focus, textarea:focus, textarea[type="text"]:focus':
        {
          ...
          boxShadow:
            "0 0 0 .2rem var(--cirrus-select-bg), inset 0 1px 8px rgba(0,0,0,.07)",
        },
      "@global .font-thin": {
        "font-weight": "400",
      },
